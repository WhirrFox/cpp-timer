...
// Location of log file (default: "log.csv")
#define filename "log.csv"

// History: Number of entries per page (default: 3)
#define perPage 3
...
// Break: Minimum break time for break to happen (in seconds, default: 10)
#define minBreakTime 10
